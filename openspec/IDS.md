...
| **aaa-009** | tokens-add-z-index          | archived | 2026-06-08    | modifica [design-tokens-package](specs/design-tokens-package/spec.md) (ADDED z-index + overlay motion + effect.blur) | [ADR-003](../docs/architecture/adr/ADR-003-arquitectura-design-tokens.md)                                                                                            | [archive/aaa-009-tokens-add-z-index](changes/archive/aaa-009-tokens-add-z-index/)                   |

**Próximo ID disponible**: `aaa-010`.
