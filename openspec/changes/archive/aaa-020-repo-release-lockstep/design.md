...
Las decisiones técnicas de este change viven en ADR-015 (opciones evaluadas, trade-offs y la mecánica `fixed` + `workspace:^`). Este design no duplica ese contenido.
