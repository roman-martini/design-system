...
- **THEN** Vitest SHALL cubrir: `role="switch"` + toggle por el input, CVA (`writeValue`/`onChange`/`setDisabledState`), reflejo de `size` en el host, label asociado, y no-hardcodes en el CSS fuente
