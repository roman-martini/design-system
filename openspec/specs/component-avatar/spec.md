...
Contrato de `DsAvatar` y `DsAvatarGroup`: identidad visual de usuarios con imagen y fallback determinístico a iniciales (tono por hash del nombre), y grupo apilado con solape por `space.negative.*` y overflow "+N" accesible.
