...
Contrato de `DsMenu` (familia trigger/menu/item/separator): patrón APG menu button sobre Popover API, placements, submenús anidados, item danger y disabled accesible.
