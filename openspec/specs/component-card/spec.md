...
Contrato de la familia `DsCard`: contenedor con variantes de elevación y padding tokenizados, sub-partes opcionales con selector híbrido y semántica del consumidor preservada.
