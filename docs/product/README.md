...
EP-001: Parte H (tokens)           → bloque de sistema Hecho (aaa-052, 2026-08-07) +
                                    matriz brand×scheme (aaa-054, surgida en su gate);
                                    resta aaa-053 (deuda component.*, propuesto con
                                    decisiones del PO tomadas)
