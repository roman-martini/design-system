...
EP-005: gates automáticos          → 7 HUs aprobadas por D-021 (HU-026…HU-032), 2/7 entregadas:
                                    HU-032 /ds:audit-tokens (2026-07-27) y HU-026 coverage +
                                    typecheck (2026-07-29, aaa-040). Siguen Refinadas contraste
                                    AA, axe, angular-eslint, bundle size y Storybook publicado
