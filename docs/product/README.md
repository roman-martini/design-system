...
EP-002: fixes de componentes       → Parte G de la review, 2/7: aaa-045 endurece el menú
                                    (hover-timer, panel cerrado, superficie de exports) y
                                    aaa-046 el select (touched, typeahead, ancho estable)
