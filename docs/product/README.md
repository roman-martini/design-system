...
EP-002: fixes de componentes       → Parte G de la review, 4/7: aaa-045 menú (hover-timer,
                                    panel cerrado, exports), aaa-046 select (touched,
                                    typeahead, ancho estable), aaa-047 toast (el primer
                                    anuncio ya no se pierde) y aaa-048 modal (nombre
                                    accesible sin heading)
