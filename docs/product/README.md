...
EP-002: tanda 2 (D-011)           → HU-012 Menu, HU-013 Accordion y HU-014 Breadcrumbs Hechas
                                    (aaa-025/026/027; Breadcrumbs genera ADR-017); HU-015
                                    Pagination ACTIVADA (BACKLOG § Now); en cola: HU-016 Progress
...
Última entrega: HU-014 (Breadcrumbs) Hecha — aaa-027 archivado el 2026-07-20, tanda 2 en 3/5; primer secondary entry point del kit (ADR-017).
