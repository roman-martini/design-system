...
EP-002: fixes de componentes       → Parte G de la review, 5/7: aaa-045 menú (hover-timer,
                                    panel cerrado, exports), aaa-046 select (touched,
                                    typeahead, ancho estable), aaa-047 toast (el primer
                                    anuncio ya no se pierde), aaa-048 modal (nombre
                                    accesible sin heading) y aaa-049 button (alturas
                                    tokenizadas, type submit, ícono-only con nombre)
